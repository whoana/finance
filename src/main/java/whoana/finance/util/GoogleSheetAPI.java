...
public class GoogleSheetAPI {
	//클라언트 ID
	//306807480235-l59lnmcpdhqoitfakjg6i8fjasb3f14p.apps.googleusercontent.com
	//클라이언트보안 비밀번호 
	//cbDzL43LOsHQDhbySaT7nuTm
	//spreadsheetId
	//1a92otuuxjHw_vCoowXYnKpJjaZTABHD7aEml7mIvuic
	
	//https://docs.google.com/spreadsheets/d/1a92otuuxjHw_vCoowXYnKpJjaZTABHD7aEml7mIvuic/edit#gid=1590594064
    ...
    public static Credential getServiceAccountAuthorize() throws IOException {
    	...
    	InputStream in = GoogleSheetAPI.class.getResourceAsStream("/service_secret.json");
    ...
    public static void main(String[] args) throws IOException {
        ...
        String range = "종목!A2:E43";
        ValueRange response = service.spreadsheets().values()
                .get(spreadsheetId, range)
                .execute();
        List<List<Object>> values = response.getValues();
        
        System.out.println("res:" + Util.toJSONPrettyString(values));
